...
namespace DisplayUtility
{
    public partial class profileForm : Form
    {
        ...
        {
            foreach(String screenName in ScreenInterrogatory.GetAllMonitorsFriendlyNames())
            {
                availableDisplaysCheckedListBox.Items.Add(screenName);
            }
        }

        [DllImport("user32.dll")]
        static extern bool EnumDisplayDevices(string lpDevice, uint iDevNum, ref DISPLAY_DEVICE lpDisplayDevice, uint dwFlags);[StructLayout(LayoutKind.Sequential, CharSet = CharSet.Ansi)]
